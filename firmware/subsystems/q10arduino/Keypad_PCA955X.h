...
#ifndef KEYPAD_PCA955X_H
#define KEYPAD_PCA955X_H
...
class Keypad_PCA955X : public Keypad {
public:
	Keypad_PCA955X(char* userKeymap, byte* row, byte* col, byte numRows, byte numCols, byte address, byte width = 1);
